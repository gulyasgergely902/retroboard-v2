<template>
  <div
    class="flex content-center h-12 dark:bg-slate-900 px-3 w-full"
  >
    <FilterToggle
      class="flex-1"
  ...
  >
    <template #default="{ item }">
      <div class="bg-sky-500 text-sky-950 hover:bg-sky-300 dark:bg-slate-600 dark:text-slate-50 dark:hover:bg-slate-500 transition-colors rounded-xl p-4">
